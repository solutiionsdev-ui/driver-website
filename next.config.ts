...
const nextConfig: NextConfig = {
  ...
  // The dev-only "N" badge. Bottom-left is where the hero puts its social
  // links, and it sat on top of them. Never shipped — this only moves it out
  // of the way while developing.
