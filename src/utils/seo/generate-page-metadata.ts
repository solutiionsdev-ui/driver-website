...
export function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      url,
      siteName,
      // Dimensions must match the real asset, or scrapers reserve the wrong
      // box and letterbox the card. `scripts/generate-open-graph.mjs` emits
      // 1200×630 — change both together.
