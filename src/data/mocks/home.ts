...
export const homeContent: HomeContent = {
  hero: {
    ...
    driver: {
      ...
      firstName: "athlete",
      lastName: "name",
      tagline: "Team name, 2026 season",
      portrait: "/assets/hero/scene/person-diffuse.webp",
      meta: [
        {
          icon: `${UI}/flag-placeholder.svg`,
          iconAlt: "Nationality",
          iconWidth: 18,
          iconHeight: 12,
          label: "Nationality",
  ...
  paddock: {
    ...
    intro:
      "A composed drive through a difficult weekend secured another podium — and kept the athlete at the top of the championship.",
    ...
    entries: [
      {
        ...
        copy: "As a child, the athlete discovered karting — turning a curiosity into something of their own.",
        copyWidth: 228,
        image: "/assets/timeline/2012.webp",
        alt: "The athlete in kart overalls in the paddock as a child",
      },
      {
        year: "2015",
        frame: "side",
        ...
        alt: "The athlete holding a karting trophy at sunset",
      },
      {
        year: "2019",
        frame: "centre",
        copyLead: "Finding their people.",
        copy: "The athlete joined a junior programme, marking their first major step into professional motorsport.",
        copyWidth: 272,
        image: "/assets/timeline/2019.webp",
        alt: "The athlete signing with a junior team",
      },
      {
        year: "2021",
        frame: "side",
        ...
        alt: "The athlete beside a single-seater in the garage",
      },
      {
        year: "2024",
        frame: "centre",
        copyLead: "The year everything changed.",
        copy: "Formula 2 brought the athlete closer to F1, and a team confirmed them as its future race driver.",
        copyWidth: 278,
        image: "/assets/timeline/2024.webp",
        alt: "The athlete walking the pit lane in team kit",
      },
      {
        year: "2025",
        frame: "side",
        ...
        alt: "The athlete in the team garage",
      },
      {
        year: "2026",
        frame: "centre",
        copyLead: "From karts to f1.",
        copy: "The athlete is now racing at the highest level, with home still their anchor — family and life beyond racing.",
        copyWidth: 284,
        image: "/assets/timeline/2026.webp",
        alt: "The team's F1 car on track",
      },
    ],
  },
};
